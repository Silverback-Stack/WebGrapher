    ...
    <div class="login-box card">
      <div class="card-content">
        ...
        <h2 class="has-text-centered mb-5">
          WebGrapher is a distributed, scalable, event-driven microservices platform
          that crawls web pages, extracts and graphs relational data,
          and streams it live for real-time visualisation.
        </h2>
